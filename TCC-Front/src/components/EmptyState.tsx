// Estado vazio.
//
// Uma tela vazia é um convite para agir, não um aviso de erro: por isso todo
// estado vazio aqui diz o que fazer em seguida, e não apenas o que falta.
...
export default function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-ink-200 bg-ink-50/40 px-6 py-12 text-center">
      <span className={`mb-4 flex h-14 w-14 items-center justify-center rounded-2xl text-3xl ring-1 ${ring}`}>
        {icon}
      </span>
